// source snippet: key=lib_rerooting_2  prefix=lib_rerooting_2

// ---------- begin Rerooting ----------

// fn main() {
//     input!(n: usize, edge: [(Usize1, Usize1); n - 1]);
//     let res = rerooting_dp(
//         &edge,
//         (0u64, 0u64),
//         |&(sum0, siz0), &(sum1, siz1)| (sum0 + sum1, siz0 + siz1),
//         |&a, _| a,
//         |a, _| (a.0 + a.1, a.1 + 1),
//     );
//     for res in res {
