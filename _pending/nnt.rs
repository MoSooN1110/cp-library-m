// source snippet: key=lib_nnt  prefix=lib_nnt

//https://judge.yosupo.jp/submission/36690
// ---------- begin ModInt ----------
mod modint {
    ...
    pub struct ModInt<T>(pub u32, marker::PhantomData<T>);
